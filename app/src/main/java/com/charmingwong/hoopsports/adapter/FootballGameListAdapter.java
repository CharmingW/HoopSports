...
import com.charmingwong.hoopsports.entity.footballgame.Saicheng1;
...
public class FootballGameListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List parseData(Map<String, Object> footballGameData) {
        List<Object> data = new ArrayList();
        Tabs tabs = (Tabs) footballGameData.get("tabs");
        Views views = (Views) footballGameData.get("list");
        data.add(tabs.getSaicheng1());
        data.addAll(views.getSaicheng1());
        data.add(tabs.getSaicheng2());
        data.addAll(views.getSaicheng2());
        return data;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            ...
            return new FootballGameListHeaderViewHolder(itemView);
        }
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof FootballGameListAdapter.FootballGameListViewHolder) {
            FootballGameListViewHolder itemHolder = (FootballGameListViewHolder) holder;
            if (mData.get(position) instanceof Saicheng1) {
                final Saicheng1 saicheng = (Saicheng1) mData.get(position);
                String team1 = saicheng.getC4T1();
                ...
                itemHolder.homeImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        intent.setData(Uri.parse(saicheng.getC4T1URL()));
                ...
                itemHolder.guestImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), WebActivity.class);
                        intent.setData(Uri.parse(saicheng.getC4T2URL()));
                        v.getContext().startActivity(intent);
                    }
                });
                itemHolder.homeName.setText(team1);
                itemHolder.guestName.setText(team2);
                itemHolder.score.setText(saicheng.getC4R());
                itemHolder.statistics.setText(saicheng.getC51());
                itemHolder.statistics.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), WebActivity.class);
                        intent.setData(Uri.parse(saicheng.getC51Link()));
                        v.getContext().startActivity(intent);
                    }
                });
                itemHolder.highlights.setText(saicheng.getC52());
                itemHolder.highlights.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), WebActivity.class);
                        intent.setData(Uri.parse(saicheng.getC52Link()));
                        v.getContext().startActivity(intent);
                    }
                });
            } else {
                final Saicheng2 saicheng = (Saicheng2) mData.get(position);
                String team1 = saicheng.getC4T1();
                String team2 = saicheng.getC4T2();
                itemHolder.time.setText(saicheng.getC2() + " " + saicheng.getC3());
                String status = saicheng.getC1();
            ...
            FootballGameListHeaderViewHolder headerHolder = (FootballGameListHeaderViewHolder) holder;
    ...
    static class FootballGameListHeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        FootballGameListHeaderViewHolder(View itemView) {
            super(itemView);
